...
function(e, t, a) {
    ...
    function i(a, i, n) {
        ...
        r.init = function() {
            var a = e(t),
            o = e(r.table);
            if (t.footable.plugins.init(r), o.hasClass(d.loaded)) return void r.raise(s.alreadyInitialized);
            ...
            if (l.addRowToggle) {
                ...
                for (var o in r.columns) {
                    ...
                    if (i.toggle) {
                        ...
                        return void t.find(n).not("." + d.detailCell).prepend(e(l.toggleHTMLElement).addClass(d.toggle))
                    }
                }
        ...
        r.getColumnData = function(t) {
            ...
            if (p > 1) {
                ...
                g = g || "",
                g = g.split(",");
                for (var b = 0; b < p; b++) n.matches.push(b + c),
                b < g.length && (n.names[b + c] = g[b])
        ...
        r.resize = function() {
            ...
            if (t.is(":visible") && r.hasAnyBreakpointColumn()) {
                ...
                if (t.data("footable_info", a), r.raise(s.resizing, {
                    ...
                    for (var i, n = null,
                    l = 0; l < r.breakpoints.length; l++) if (i = r.breakpoints[l], i && i.width && a.width <= i.width) {
                        n = i;
                        break
                    }
        ...
        r.createOrUpdateDetailRow = function(t) {
            ...
            if (r.raise(s.rowDetailUpdating, {
                ...
                o = a.name;
                return a.ignore === !0 || (t in a.names && (o = a.names[t]), n.push({
                    name: o,
    ...
    t.footable = {
        ...
        plugins: {
            ...
            load: function(e) {
                var a, o, i = [];
                for (o = 0; o < t.footable.plugins.registered.length; o++) try {
