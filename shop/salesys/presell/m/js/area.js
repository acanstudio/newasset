...
dsy.add("0_0_0",["东城区","西城区","崇文区","宣武区","朝阳区","丰台区","石景山区","海淀区","门头沟区","房山区","通州区","顺义区","昌平区","大兴区","怀柔区","平谷区","密云县","延庆县","延庆镇"]);dsy.add("0_0",["北京市"]);
...
dsy.add("0_18_0",["岳麓区","芙蓉区","天心区","开福区","雨花区","浏阳市","长沙县","星沙镇","望城县","高塘岭镇","宁乡县","玉潭镇"]);
...
dsy.add("0_33_0",["中正区","大同区","中山区","松山区","大安区","万华区","信义区","士林区","北投区","内湖区","南港区","文山区"]);
dsy.add("0_33_1",["新兴区","前金区","芩雅区","盐埕区","鼓山区","旗津区","前镇区","三民区","左营区","楠梓区","小港区"]);
dsy.add("0_33_2",["仁爱区","信义区","中正区","中山区","安乐区","暖暖区","七堵区"]);
dsy.add("0_33_3",["中区","东区","南区","西区","北区","北屯区","西屯区","南屯区"]);
dsy.add("0_33_4",["中西区","东区","南区","北区","安平区","安南区"]);
dsy.add("0_33_5",["东区","北区","香山区"]);
dsy.add("0_33_6",["东区","西区"]);
dsy.add("0_33_7",["台北县(板桥市)","宜兰县(宜兰市)","新竹县(竹北市)","桃园县(桃园市)","苗栗县(苗栗市)","台中县(丰原市)","彰化县(彰化市)","南投县(南投市)","嘉义县(太保市)","云林县(斗六市)","台南县(新营市)","高雄县(凤山市)","屏东县(屏东市)","台东县(台东市)","花莲县(花莲市)","澎湖县(马公市)"]);
dsy.add("0_33",["台北","高雄","基隆","台中","台南","新竹","嘉义","县"]);dsy.add("0",["北京市","天津市","上海市","重庆市","河北省","山西省","内蒙古","辽宁省","吉林省","黑龙江省","江苏省","浙江省","安徽省","福建省","江西省","山东省","河南省","湖北省","湖南省","广东省","广西","海南省","四川省","贵州省","云南省","西藏","陕西省","甘肃省","青海省","宁夏","新疆","香港","澳门","台湾省"]);
...
/*
var $__G_Time={};var $__ms_Count={};var $__G_Timer_Count=0;var $__ms_use=true;if(typeof(__Timer_lesser_auto_accuracy)=='undefined')
{__Timer_lesser_auto_accuracy=false;}
$(document).ready(function(){if(__Timer_lesser_auto_accuracy&&$__G_Timer_Count>=__Timer_lesser_worker_max)
{$__ms_use=false;}
for(id in $__G_Time)
{showtime(id,$__G_Time[id]-1);}});function addTimeLesser(id,time)
{$__G_Time['remainTime_'+id]=time;$__G_Timer_Count++;}
function showtime(id,time,msid)
{var msC=$__ms_Count[id];if(msC==undefined)msC=0;if($__ms_use&&msC>0&&msid!='')
{$('#'+msid).text('.'+msC);msC--;$__ms_Count[id]=msC;setTimeout(function(){showtime(id,time,msid)},100);return;}
$__ms_Count[id]=9;if(time<=0)
{$('#'+ id).html('<span>活动已经结束</span>');return;}
var timeUnits={'day':{'name':'天','count':86400},'hour':{'name':'小时','count':3600},'minute':{'name':'分','count':60},'second':{'name':'秒','count':1}};var string='';var iLess=time;for(ix in timeUnits)
{var unit=timeUnits[ix];var cc=Math.floor(iLess/unit.count);var ccString=cc<10?'0'+cc.toString():cc.toString();string+='<span >'+ ccString+'</span>'+ unit.name;iLess-=cc*unit.count;}
$('#'+ id).html(string);setTimeout(function(){showtime(id,time- 1,msid)},$__ms_use?100:1000);}
function __rand_key()
{var salt='0123456789qwertyuioplkjhgfdsazxcvbnm';var str='id_';for(var i=0;i<6;i++)
